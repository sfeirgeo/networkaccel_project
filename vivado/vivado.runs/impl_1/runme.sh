...
HD_PWD='C:/Users/gsfei/OneDrive/Desktop/networkaccel_project/vivado/vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mac_udp_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mac_udp_design_wrapper.tcl -notrace
