...
HD_PWD='C:/Users/gsfei/OneDrive/Desktop/networkaccel_project/vivado/vivado.runs/mac_udp_design_fifo_generator_0_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mac_udp_design_fifo_generator_0_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mac_udp_design_fifo_generator_0_4.tcl
