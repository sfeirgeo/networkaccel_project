...
HD_PWD='C:/Users/gsfei/OneDrive/Desktop/networkaccel_project/vivado/vivado.runs/mac_udp_design_mac_filter_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mac_udp_design_mac_filter_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mac_udp_design_mac_filter_0_2.tcl
