...
#                script (type 'mac_udp_design.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/gsfei/OneDrive/Desktop/networkaccel_project/vivado/vivado.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
