...
#
# Script generated by Vivado on Mon Jun 09 13:07:33 -0400 2025
...
simulate()
{
  xsim mac_udp_design -key {Behavioral:sim_1:Functional:mac_udp_design} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_b326.protoinst" -protoinst "protoinst_files/mac_udp_design.protoinst" -log simulate.log
}
