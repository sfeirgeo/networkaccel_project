...
#
# Script generated by Vivado on Mon Jun 16 14:25:09 -0400 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : mac_udp_design.sh
...
#
# Usage        : mac_udp_design.sh
#                mac_udp_design.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mac_udp_design.sh [-reset_run]
#                mac_udp_design.sh [-reset_log]
#                mac_udp_design.sh [-help]
#
...
# script info
echo -e "mac_udp_design.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mac_udp_design.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_19 -L processing_system7_vip_v1_0_21 -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L xlconstant_v1_1_9 -L lib_pkg_v1_0_4 -L fifo_generator_v13_2_11 -L lib_fifo_v1_0_20 -L lib_srl_fifo_v1_0_4 -L axi_datamover_v5_1_35 -L axi_sg_v4_1_19 -L axi_dma_v7_1_34 -L generic_baseblocks_v2_1_2 -L axi_data_fifo_v2_1_32 -L axi_register_slice_v2_1_33 -L axi_protocol_converter_v2_1_33 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mac_udp_design xil_defaultlib.mac_udp_design xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mac_udp_design -key {Behavioral:sim_1:Functional:mac_udp_design} -tclbatch cmd.tcl -protoinst "protoinst_files/mac_udp_design.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mac_udp_design.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mac_udp_design.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mac_udp_design.sh [-help]\n\
Usage: mac_udp_design.sh [-step]\n\
Usage: mac_udp_design.sh [-lib_map_path]\n\
Usage: mac_udp_design.sh [-reset_run]\n\
Usage: mac_udp_design.sh [-reset_log]\n\
Usage: mac_udp_design.sh [-keep_index]\n\
Usage: mac_udp_design.sh [-noclean_files]\n\n\
