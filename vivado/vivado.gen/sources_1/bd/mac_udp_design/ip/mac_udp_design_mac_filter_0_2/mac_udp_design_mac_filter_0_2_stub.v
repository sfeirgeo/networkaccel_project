...
//               c:/Users/gsfei/OneDrive/Desktop/networkaccel_project/vivado/vivado.gen/sources_1/bd/mac_udp_design/ip/mac_udp_design_mac_filter_0_2/mac_udp_design_mac_filter_0_2_stub.v
...
(* CHECK_LICENSE_TYPE = "mac_udp_design_mac_filter_0_2,mac_filter,{}" *) (* CORE_GENERATION_INFO = "mac_udp_design_mac_filter_0_2,mac_filter,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=mac_filter,x_ipVersion=1.0,x_ipCoreRevision=12,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,MAC_ADDR=0xDEADBEEF1234}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "mac_filter,Vivado 2024.2" *) 
module mac_udp_design_mac_filter_0_2(clk, rst_n, s_axis_tvalid, s_axis_tready, 
  s_axis_tdata, s_axis_tlast, m_axis_tvalid, m_axis_tready, m_axis_tdata, m_axis_tlast)
/* synthesis syn_black_box black_box_pad_pin="rst_n,s_axis_tvalid,s_axis_tready,s_axis_tdata[31:0],s_axis_tlast,m_axis_tvalid,m_axis_tready,m_axis_tdata[31:0],m_axis_tlast" */
