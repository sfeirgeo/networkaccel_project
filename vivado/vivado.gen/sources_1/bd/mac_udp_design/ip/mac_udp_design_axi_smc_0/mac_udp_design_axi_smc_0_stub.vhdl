...
-- Date        : Thu Jun  5 17:35:47 2025
-- Host        : geo running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub -rename_top mac_udp_design_axi_smc_0 -prefix
--               mac_udp_design_axi_smc_0_ mac_udp_design_axi_smc_0_stub.vhdl
-- Design      : mac_udp_design_axi_smc_0
...
entity mac_udp_design_axi_smc_0 is
  Port ( 
    aclk : in STD_LOGIC;
  ...
  attribute CHECK_LICENSE_TYPE of mac_udp_design_axi_smc_0 : entity is "mac_udp_design_axi_smc_0,bd_b326,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of mac_udp_design_axi_smc_0 : entity is "mac_udp_design_axi_smc_0,bd_b326,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=25,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of mac_udp_design_axi_smc_0 : entity is "yes";
end mac_udp_design_axi_smc_0;

architecture stub of mac_udp_design_axi_smc_0 is
  ...
  attribute X_INTERFACE_PARAMETER of aclk : signal is "XIL_INTERFACENAME CLK.aclk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN mac_udp_design_processing_system7_0_0_FCLK_CLK0, ASSOCIATED_BUSIF M00_AXI:S00_AXI, INSERT_VIP 0, ASSOCIATED_CLKEN s_sc_aclken";
  ...
  attribute X_CORE_INFO of stub : architecture is "bd_b326,Vivado 2024.2";
begin
end;
