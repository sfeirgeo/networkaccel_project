...
(* CHECK_LICENSE_TYPE = "mac_udp_design_mac_filter_0_1,mac_top,{}" *) (* CORE_GENERATION_INFO = "mac_udp_design_mac_filter_0_1,mac_top,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=mac_filter,x_ipVersion=1.0,x_ipCoreRevision=8,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
